#why pipeline?
#this pipeline injects the raw log data using dask bag. parse them into structured data with the help of dask data frame,
#  we can filter the invalid log entries and converts into data frame using meta data.

#why meta data?
#dask cannot guess the column type automatically , we tell dask what is key and what is the value(passing key and value pairs)
